...
public class SendSms
{
  public static void main( String[] args )
  {
      try {
          ...
          // 设置代理
          httpProfile.setProxyHost("localhost");
...
//          httpProfile.setEndpoint("sms.tencentcloudapi.com");
          ...
          String[] phoneNumbers = {"+8613311085109"};
          req.setPhoneNumberSet(phoneNumbers);
           /* 模板参数: 若无模板参数，则设置为空*/
          String[] templateParams = {"傻憨憨","2020-04-21 14:05:00","188","888"};
